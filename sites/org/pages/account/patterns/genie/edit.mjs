...
const EditGeniePage = ({ page }) => {
  ...
  return (
    // prettier-ignore
    <PageWrapper {...page} title="Genie" layout={pattern ? WorkbenchLayout : false} header={null}>
      {pattern ? (
        <EditDesignComponent
          id={pattern.id}
