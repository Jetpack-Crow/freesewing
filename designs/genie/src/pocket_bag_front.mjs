function draft_pocket_bag_front({
    ...
    points.pocketBottom = new Point(body_width * options.pocketBottomX, -1 * body_length * options.pocketBottomY)
    points.pocketTop = new Point(body_width * options.pocketTopX, -1 * body_length * options.pocketTopY)
    ...
    points.bagTopCorner = new Point(points.pocketTop.x+cornerOffset, points.pocketTop.y-cornerOffset)
    points.bagBottomCorner = new Point(points.pocketBottom.x+cornerOffset, points.pocketBottom.y-cornerOffset)
