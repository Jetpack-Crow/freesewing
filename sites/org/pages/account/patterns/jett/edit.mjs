...
const EditJettPage = ({ page }) => {
  ...
  return (
    // prettier-ignore
    <PageWrapper {...page} title="Jett" layout={pattern ? WorkbenchLayout : false} header={null}>
      {pattern ? (
        <EditDesignComponent
          id={pattern.id}
